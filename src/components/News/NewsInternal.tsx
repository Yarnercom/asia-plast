...
const NewsInternal: React.FC<NewsInternalProps> = ({ news }) => {
    ...
    return (
        <motion.div initial="hidden" whileInView="visible" variants={blockAnimation} className="rounded-lg overflow-hidden w-[90%] m-auto">
            <div className="flex">
                <div className="relative w-[550px] h-[350px] float-left">
                ...
                <div className="bg-white pt-6">
                    <p className="text-[#000000] text-lg md:text-xl leading-relaxed">
                        {news.description || 'Описание не доступно.'}
                    </p>
                </div>
            </div>
        </motion.div>
