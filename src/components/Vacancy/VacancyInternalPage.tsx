...
const VacancyInternal: React.FC<VacancyInternalProps> = ({ vacancy }) => {
    ...
    return (
        <motion.div initial="hidden" whileInView="visible" variants={blockAnimation} className="max-w-2xl mx-auto p-6 border border-gray-300 rounded-lg bg-white shadow-lg">
